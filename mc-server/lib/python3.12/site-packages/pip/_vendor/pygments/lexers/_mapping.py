...
LEXERS = {
    ...
    'DebianControlLexer': ('pip._vendor.pygments.lexers.server', 'Debian Control file', ('debcontrol', 'control'), ('control',), ()),
    ...
    'NSISLexer': ('pip._vendor.pygments.lexers.server', 'NSIS', ('nsis', 'nsi', 'nsh'), ('*.nsi', '*.nsh'), ('text/x-nsis',)),
    ...
    'RPMSpecLexer': ('pip._vendor.pygments.lexers.server', 'RPMSpec', ('spec',), ('*.spec',), ('text/x-rpm-spec',)),
    ...
    'SourcesListLexer': ('pip._vendor.pygments.lexers.server', 'Debian Sourcelist', ('debsources', 'sourceslist', 'sources.list'), ('sources.list',), ()),
